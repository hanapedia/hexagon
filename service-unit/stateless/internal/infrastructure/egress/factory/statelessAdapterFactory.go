...
func statelesEgressAdapterFactory(adapterConfig model.StatelessEgressAdapterConfig, client core.EgressClient) (core.EgressAdapter, error) {
...
func getOrCreateStatelessEgressClient(adapterConfig model.StatelessEgressAdapterConfig, clients *map[string]core.EgressClient) core.EgressClient {
