...
// IngressAdapterList contains a list of IngressAdapter
type IngressAdapterList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []IngressAdapter `json:"items"`
}

func init() {
	SchemeBuilder.Register(&IngressAdapter{}, &IngressAdapterList{})
}
